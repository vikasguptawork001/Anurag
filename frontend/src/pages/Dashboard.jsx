    ...
    <div className="flex min-h-0 flex-col gap-5 lg:gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-sm text-slate-600">Service activity and upcoming work at a glance.</p>
        </div>
        <div className="flex w-full shrink-0 flex-col gap-2 sm:w-auto sm:flex-row sm:items-center sm:justify-end">
          ...
          <Link
            to="/vehicle-history"
            className="inline-flex h-11 w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-5 text-sm font-semibold text-slate-800 shadow-sm transition hover:bg-slate-50 sm:h-10 sm:min-w-[10.5rem]"
          >
            Vehicle lookup
          </Link>
        </div>
      ...
      <section className="grid min-h-0 flex-1 grid-cols-1 gap-5 lg:grid-cols-2 lg:gap-6 lg:items-stretch">
        <div className="flex min-h-0 min-w-0 flex-col">
          <div className="mb-2 flex items-end justify-between gap-2">
            <div>
              <h2 className="text-base font-semibold text-slate-900 sm:text-lg">Recent services</h2>
              <p className="text-xs text-slate-500">Last 10 records</p>
            </div>
          </div>
        ...
        <div className="flex min-h-0 min-w-0 flex-col">
          <div className="mb-2">
            <h2 className="text-base font-semibold text-slate-900 sm:text-lg">Upcoming reminders</h2>
            <p className="text-xs text-slate-500">Due within 7 days (incl. overdue)</p>
          </div>
          <div className="flex min-h-0 max-h-[min(360px,calc(100dvh-17rem))] flex-col overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            ...
            <div className="min-h-0 flex-1 space-y-2 overflow-y-auto overscroll-contain p-3 scrollbar-thin sm:p-4">
              {!data?.upcomingReminders?.length ? (
                <p className="py-8 text-center text-sm text-slate-600">No reminders in this window.</p>
              ) : (
